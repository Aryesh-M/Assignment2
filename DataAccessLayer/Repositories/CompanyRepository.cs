...
namespace DataAccessLayer.Repositories
{
	public class CompanyRepository : ICompanyRepository
	{
		...
		{
			IEnumerable<Company> companies = await _companyDbWrapper.FindAsync(t => t.CompanyCode.Equals(companyCode));
		...
		{
			return await _companyDbWrapper.DeleteAsync(t => t.CompanyCode == companyCode.ToString());
		}
	}
}
